    ...
    return {
        ...
        init: function () {
            ...
            $('#editable-sample a.delete').live('click', function (e) {
                ...
                var aData = oTable.fnGetData(nRow);
                $.postJSON('/web/general/delete', {name:aData[0].value,password:aData[1]},function(result){
                    if(result.success)
                    {
                        location.href = "/web/generaluser";
                    }
                    else
                    {
            ...
            $('#editable-sample a.edit').live('click', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    nEditing = null;
                    $.postJSON('/web/generaluser/edit', {name:jqInputs[0].value,password:jqInputs[1].value,time:jqInputs[2].value,age:jqInputs[4].value,email:jqInputs[5].value,birth:jqInputs[6].value,content:jqInputs[7].value},function(result){
                        if(result.success)
                        {
                            location.href = "/web/generaluser";
                        }
