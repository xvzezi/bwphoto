        ...
        init: function () {
            ...
            $('#editable-sample a.edit').live('click', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    nEditing = null;
                    $.postJSON('/web/admin/edit', {name:jqInputs[0].value,password:jqInputs[1].value,time:jqInputs[2].value,age:jqInputs[4].value,email:jqInputs[5].value,birth:jqInputs[6].value,content:jqInputs[7].value},function(result){
                        if(result.success)
                        {
                            location.href = "/web/admin";
                        }
